...
public final class ScheduleTaskServerExample {

    private static final InternalLogger LOGGER = InternalLoggerFactory.getInstance(ScheduleTaskServerExample.class);

    private ScheduleTaskServerExample() { }
